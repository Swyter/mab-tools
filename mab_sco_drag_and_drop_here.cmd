...
if "%~1"=="" (
    ...
    echo  ┌───────────────────────────────────────────────────────────────────────────────────────┐
    echo  │ Drag and drop your .sco file, mission_objects.json or unpacked folder over            │
...
:unpack
    echo.[/] calling «mab_sco_unpack» %* && echo.    --
    "%~dp0/mab_sco_unpack" %*
    goto :end

:unpacked_reindex
    echo.[/] calling mab_sco_unpacked_reindex %~dp1 && echo.    --
    "%~dp0/mab_sco_unpacked_reindex" %~dp1
    goto :end

:repack
    echo.[/] calling mab_sco_repack %* && echo.    --
    "%~dp0/mab_sco_repack" %*
    goto :end
